...
public class PullRequest {
    ...
    public String toString() {
        return new StringBuilder().append("PullRequest [consumerGroup=").append(consumerGroup).append(", messageQueue=").append(messageQueue).append(", nextOffset=").append(nextOffset).append("]")
				.toString();
    }
