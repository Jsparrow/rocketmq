...
public class PushConsumerWithNamespace {
    private static final Logger logger = LoggerFactory.getLogger(PushConsumerWithNamespace.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        defaultMQPushConsumer.registerMessageListener((MessageListenerConcurrently)(msgs, context) -> {
            msgs.stream().forEach((msg) -> logger.info("Msg topic is:%s, MsgId is:%s, reconsumeTimes is:%s%n", msg.getTopic(), msg.getMsgId(),
