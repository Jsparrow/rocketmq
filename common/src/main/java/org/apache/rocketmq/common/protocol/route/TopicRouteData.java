...
public class TopicRouteData extends RemotingSerializable {
    ...
    public String toString() {
        return new StringBuilder().append("TopicRouteData [orderTopicConf=").append(orderTopicConf).append(", queueDatas=").append(queueDatas).append(", brokerDatas=").append(brokerDatas).append(", filterServerTable=")
				.append(filterServerTable).append("]").toString();
    }
}
