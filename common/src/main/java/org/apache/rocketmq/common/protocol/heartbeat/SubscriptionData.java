...
public class SubscriptionData implements Comparable<SubscriptionData> {
    ...
    public String toString() {
        return new StringBuilder().append("SubscriptionData [classFilterMode=").append(classFilterMode).append(", topic=").append(topic).append(", subString=").append(subString).append(", tagsSet=")
				.append(tagsSet).append(", codeSet=").append(codeSet).append(", subVersion=").append(subVersion).append(", expressionType=").append(expressionType)
				.append("]").toString();
    }

    @Override
    public int compareTo(SubscriptionData other) {
        String thisValue = new StringBuilder().append(this.topic).append("@").append(this.subString).toString();
        String otherValue = new StringBuilder().append(other.topic).append("@").append(other.subString).toString();
